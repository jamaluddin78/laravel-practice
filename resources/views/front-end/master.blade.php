                            ...
                            <ul class="dropdown-menu multi">
                                <div class="row">
                                    ...
                                    <div class="col-sm-3 w3l">
                                        <a href="kitchen.html"><img src="{{asset('/')}}front/images/me.png" class="img-responsive" alt=""></a>
                                    </div>
                            ...
                            <ul class="dropdown-menu multi multi1">
                                <div class="row">
                                    ...
                                    <div class="col-sm-3">
                                        ...
                                        <ul class="multi-column-dropdown">
                                            <li><a href="{{route('hair-care')}}"> <i class="fa fa-angle-right" aria-hidden="true"></i>Hair Care </a></li>
                                    ...
                                    <div class="col-sm-3 w3l">
                                        <a href="care.html"><img src="{{asset('/')}}front/images/me1.png" class="img-responsive" alt=""></a>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            </ul>
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu multi multi2">
                                <div class="row">
                                    ...
                                    <div class="col-sm-3 w3l">
                                        <a href="hold.html"><img src="{{asset('/')}}front/images/me2.png" class="img-responsive" alt=""></a>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            </ul>
